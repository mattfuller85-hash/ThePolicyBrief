...
V7_SCHEMA = """
{
  ...
  "heygen_short_script": "String (CRITICAL LENGTH REQUIREMENT: MUST be a 5 to 7 minute in-depth script with a STRICT MINIMUM of 800-1000 words. Provide a highly detailed summary of the bill's actual effects and potential consequences. If the bill has NO spending (like a simple resolution), provide deep historical context. MANDATORY OPENING: If a sponsor name is passed as input it MUST start EXACTLY: 'Proposed by {sponsor name}, Bill {Bill ID}, otherwise known as the \\'{Bill Title}\\'...'. CRITICAL INSTRUCTION: You MUST explicitly declare the exact 'winners' and 'losers' of the bill, specifying which industries prospered/were damaged. SHOW NAME MANDATE: The name of the show is 'The Policy Brief'. You must NEVER refer to the show as 'Capitol Watchdog' or 'Capitol Watch'. TONE RULE: This show is NOT exclusively negative. If the proposed bill is high quality, tackles a good cause, or is generally beneficial without pork, you MUST highlight that affirmatively and praise the effort. You MUST explicitly state when the bill goes up for a vote (if known) and if this is the first time the bill has been proposed. CRITICALLY: IF pork exists, quote the exact text from the bill. Maintain a professional tone without using AI-like words such as 'audit' or 'delve'.)",
